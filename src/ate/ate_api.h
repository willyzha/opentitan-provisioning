...
/**
 * Checks if a blob was generated by a legacy V0 firmware.
 *
 * @param body The personalization blob body.
 * @param size The size of the blob body.
 * @return true if the blob uses legacy V0 headers, false otherwise.
 */
 ...
 * @param is_legacy_v0 Whether to pack the blob using the legacy V0
 * header format.
