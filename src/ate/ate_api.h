...
/**
 * Checks if a blob was generated by a legacy V1 firmware.
 *
 * @param body The personalization blob body.
 * @param size The size of the blob body.
 * @return true if the blob uses legacy V1 headers, false otherwise.
 */
 ...
 * @param is_legacy_v1 Whether to pack the blob using the legacy V1
 * header format.
