...
def _sphincsplus_repos(local = None):
    http_archive(
        ...
        build_file = Label("//third_party/sphincsplus_repo:BUILD.sphincsplus_common.bazel"),
    ...
    http_archive(
        ...
        build_file = Label("//third_party/sphincsplus_repo:BUILD.sphincsplus.bazel"),
        sha256 = "b301faa7a42ef538323a732929d49341b1cbd8375f643f7d98ca32cd6efacc32",
        patches = [
            Label("//third_party/sphincsplus_repo/patches:sphincsplus-namespace.patch"),
        ],
        patch_args = ["-p2"],
    )
